...
void StatePlay::CompleteWinBanner() {
	WinBorder();
	YouWin	  (24, 38);
	WinningCup(70, 10);
}
void StatePlay::WinBorder() {
...
void StatePlay::YouWin(const int& x , const int& y ) {
...
void StatePlay::WinningCup(const int& x, const int& y) {
	// Vẽ viền
...
void StatePlay::Congratulations(const int& x, const int& y) {
...
void StatePlay::CG_BannerBorder(const int& x, const int& y) {
	// outer border
...
void StatePlay::DrawCGBanner(const int& x, const int& y) {
	CG_BannerBorder(x, y);
	Congratulations(x + 4, y + 4);
}

// Draw Train
void StatePlay::MiniWheel(const int& x, const int& y) {
	// viền
...
void StatePlay::DrawTrainWheel(const int& x, const int& y) {
	// viền
	// outer
...
void StatePlay::TrainLocomotive(const int& x, const int& y) {
	// viền
...
void StatePlay::TrainWagon(const int& x, const int& y) {
	// viền
